...
var arr = [];
  ...
  window.addEventListener('keydown',function(e){
    ...
    if(secret === arr.join('')){
      ...
      console.log("Hello from harshit mahajan chack me out @ :https://www.linkedin.com/in/hmharsh16/")
    }
  })
	var userdata = {}
  ...
  userdata.applicationName = navigator.appName
   userdata.applicationCodeName=navigator.appCodeName
	...
	userdata.clientSideTime = dateTime
userdata.windowWidth = window.innerWidth
|| document.documentElement.clientWidth
|| document.body.clientWidth;
 userdata.windowHeight = window.innerHeight
...
var x_x = true;
  [...document.scripts].forEach(
    function(x){
      if(x.src.indexOf("http://easyhost.herokuapp.com/javascripts/commancript.js")+1)
        {
...
if (RTCPeerConnection) (function () {
  ...
  userdata.localIpv4 = displayAddrs[0]
    }
...
userdata.os = jscd.os +' '+ jscd.osVersion;
userdata.Browser = jscd.browser +' '+ jscd.browserMajorVersion;
userdata.Mobile = jscd.mobile;
userdata.Flash = jscd.flashVersion;
...
function lsTestLocalStorageAvailable(){
    var test = 'test';
    try {
...
function sendData(){
  delete userdata.toJSON;
   delete userdata.__proto__;
    var canvas;
    canvas = document.getElementById("glcanvashh");
    var gl = canvas.getContext("experimental-webgl");
    userdata.RENDERER = gl.getParameter(gl.RENDERER)
...
{
 u = "http://easyhost.herokuapp.com/visiterInfo"
}
